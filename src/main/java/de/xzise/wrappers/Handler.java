...
public class Handler<W extends Wrapper> {
    ...
    /**
     * Updates the plugin name which should be used. Loads automatically afterwards.
            ...
            if (!MinecraftUtil.isSet(this.pluginName) || (pdf.getName().equalsIgnoreCase(this.pluginName))) {
                ...
                if (factory != null) {
                    if (plugin.isEnabled()) {
                        ...
                        if (this.wrapper == null) {
                            this.logger.warning("Invalid " + type + " system found: " + pdf.getFullName());
                        } else {
                            this.loaded();
                            this.logger.info("Linked with " + type + " system: " + pdf.getFullName());
                        }
                    } else {
                        this.logger.warning("Doesn't link to disabled " + type + " system: " + pdf.getFullName());
                    }
                }
            }
        }
